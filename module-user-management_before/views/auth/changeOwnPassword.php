...
<div class="change-own-password">
	...
	<h2 class="lte-hide-title"><?= $this->title ?></h2>
        <?php if (isset($_GET['exp']) && ($_GET['exp']=='1')) 
            echo '<h4 class="lte-hide-title">Your password has been expire and recomended to change for security</h4>';
            
        echo Yii::$app->getModule('user-management')->passwordRequiryTitle;
        ?>
