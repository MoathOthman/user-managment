 ...
 * @property string $lastpass_changed
 * @property string $last_wrong_login
 * @property integer $wrong_count
 */
class User extends UserIdentity
{
	...
	*/
	...
	{       
                //$rules = $this->username;
                $text = isset($this->username)?trim($this->username): '';//  json_encode($rules)  ;
		...
		$return = [
			...
			['password', 'trim', 'on'=>['newUser', 'changePassword']],
                        ...
                        ['password', 'match', 'pattern' => '/^[^\s]*$/','message' => 'Whitespace is not allowed'.$text],
                        ['password', 'match', 'pattern' => Yii::$app->getModule('user-management')->passwordRegexp,'message' => Yii::$app->getModule('user-management')->passwordRequiryTitle],// 'message' => 'Invalid Password'],
	...
	public function attributeLabels()
	{
		return [
			...
			'email'              => UserManagementModule::t('back', 'E-mail'),
                        'lastpass_changed'    => UserManagementModule::t('back', 'Last password changed'),
                        'last_wrong_login'    => UserManagementModule::t('back', 'Last Wrong Login'),
                        'wrong_count'    => UserManagementModule::t('back', 'Wrong Count'),
		];
	}
